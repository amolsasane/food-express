      ...
      <div className="main max-w-[70rem] m-auto flex pb-10 pt-[6rem]">
        ...
        {isVisible && (
          <>
            ...
            <div
              className={`mt-[10vh] login-page fixed z-10 border border-gray-500 shadow-2xl bg-white w-[100vw] md:w-[40vw] right-0 top-0 h-[90vh] rounded-l-xl transition-transform ${
