  ...
  return (
    <div className="mx-[10rem]">
      <div className="flex justify-between my-[2rem]">
        <div className="flex">
          <div className="bg-neutral-400/50 w-[15rem] h-8 shimmer rounded-2xl"></div>
          <div className="bg-neutral-400/50 w-[3rem] h-8 mx-2 shimmer rounded-2xl"></div>
        </div>
        <div className="flex">
          <div className="bg-neutral-400/50 w-[4rem] h-8 mx-2 shimmer rounded-2xl"></div>
          <div className="bg-neutral-400/50 w-[4rem] h-8 mx-2 shimmer rounded-2xl"></div>
        </div>
      </div>
      ...
      <div className="button-list flex justify-center mb-10">
        <div className="bg-neutral-400/50 w-[6rem] h-12 mr-6 shimmer rounded-full"></div>
        <div className="bg-neutral-400/50 w-[7rem] h-12 mx-6 shimmer rounded-full"></div>
        <div className="bg-neutral-400/50 w-[10rem] h-12 mx-6 shimmer rounded-full"></div>
        <div className="bg-neutral-400/50 w-[7rem] h-12 mx-6 shimmer rounded-full"></div>
        <div className="bg-neutral-400/50 w-[8rem] h-12 mx-6 shimmer rounded-full"></div>
        <div className="bg-neutral-400/50 w-[15rem] h-12 mx-6 shimmer rounded-full"></div>
      </div>
