...
const Cart = () => {
  ...
  return (
    <div className="flex w-[90%] m-auto justify-around p-4">
      <div className="w-[60%] mt-4">
        ...
        <div className="flex items-center">
          ...
          />
          <div className="border-t border-gray-300 shadow-xl shadow-gray-300 px-4 py-6 rounded-lg h-[10rem] w-full">
            <div className="ml-16 mt-2 mr-4">
              ...
              <h1 className="text-gray-600">
                <span className="font-bold text-gray-600">Name :</span> XXXX
                XXXXXX
              </h1>
              <h1 className="text-gray-600">
